...
namespace Aminos.Migrations.MaimaiDXDBMigrations
{
    ...
    [Migration("20231121163519_V2_Add_SDEZ_Tables")]
    partial class V2_Add_SDEZ_Tables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserAct", b =>
                {
                    ...
                    b.Property<ulong>("UserActivityMusicListId")
                        .HasColumnType("INTEGER");

                    b.Property<ulong>("UserActivityPlayListId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UserActivityMusicListId");

                    b.HasIndex("UserActivityPlayListId");
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserGamePlaylog", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "playlogId");
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserRate", b =>
                {
                    ...
                    b.Property<ulong>("UserRatingNewRatingListId")
                        .HasColumnType("INTEGER");

                    b.Property<ulong>("UserRatingNextNewRatingListId")
                        .HasColumnType("INTEGER");

                    b.Property<ulong>("UserRatingNextRatingListId")
                        .HasColumnType("INTEGER");

                    b.Property<ulong>("UserRatingRatingListId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UserRatingNewRatingListId");

                    b.HasIndex("UserRatingNextNewRatingListId");

                    b.HasIndex("UserRatingNextRatingListId");

                    b.HasIndex("UserRatingRatingListId");
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserAct", b =>
                {
                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserActivity", null)
                        .WithMany("musicList")
                        .HasForeignKey("UserActivityMusicListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserActivity", null)
                        .WithMany("playList")
                        .HasForeignKey("UserActivityPlayListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserActivity", b =>
                {
                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserDetail", null)
                        ...
                        .HasForeignKey("Aminos.Models.Title.SDEZ.Tables.UserActivity", "UserDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserExtend", b =>
                {
                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserDetail", null)
                        .WithOne("UserExtend")
                        .HasForeignKey("Aminos.Models.Title.SDEZ.Tables.UserExtend", "UserDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserOption", b =>
                {
                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserDetail", null)
                        .WithOne("UserOption")
                        .HasForeignKey("Aminos.Models.Title.SDEZ.Tables.UserOption", "UserDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserRate", b =>
                {
                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserRating", null)
                        ...
                        .HasForeignKey("UserRatingNewRatingListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserRating", null)
                        .WithMany("nextNewRatingList")
                        .HasForeignKey("UserRatingNextNewRatingListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserRating", null)
                        .WithMany("nextRatingList")
                        .HasForeignKey("UserRatingNextRatingListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserRating", null)
                        .WithMany("ratingList")
                        .HasForeignKey("UserRatingRatingListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserRating", b =>
                {
                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserDetail", null)
                        .WithOne("UserRating")
                        .HasForeignKey("Aminos.Models.Title.SDEZ.Tables.UserRating", "UserDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Aminos.Models.Title.SDEZ.Tables.UserUdemae", b =>
                {
                    b.HasOne("Aminos.Models.Title.SDEZ.Tables.UserRating", null)
                        .WithOne("udemae")
                        .HasForeignKey("Aminos.Models.Title.SDEZ.Tables.UserUdemae", "UserRatingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
