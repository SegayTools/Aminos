        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserDetail1Id = table.Column<ulong>(type: "INTEGER", nullable: false),
                    UserDetail2Id = table.Column<ulong>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<ulong>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserDetailId = table.Column<ulong>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserExtends_MaimaiDX_UserDetails_UserDetailId",
                        column: x => x.UserDetailId,
                        principalTable: "MaimaiDX_UserDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserOptions_MaimaiDX_UserDetails_UserDetailId",
                        column: x => x.UserDetailId,
                        principalTable: "MaimaiDX_UserDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserRatings_MaimaiDX_UserDetails_UserDetailId",
                        column: x => x.UserDetailId,
                        principalTable: "MaimaiDX_UserDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<ulong>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserActivityPlayListId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    UserActivityMusicListId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    kind = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserActs_MaimaiDX_UserActivities_UserActivityMusicListId",
                        column: x => x.UserActivityMusicListId,
                        principalTable: "MaimaiDX_UserActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserActs_MaimaiDX_UserActivities_UserActivityPlayListId",
                        column: x => x.UserActivityPlayListId,
                        principalTable: "MaimaiDX_UserActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<ulong>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserRatingRatingListId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    UserRatingNewRatingListId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    UserRatingNextRatingListId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    UserRatingNextNewRatingListId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    musicId = table.Column<int>(type: "INTEGER", nullable: false),
                    level = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserRates_MaimaiDX_UserRatings_UserRatingNewRatingListId",
                        column: x => x.UserRatingNewRatingListId,
                        principalTable: "MaimaiDX_UserRatings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserRates_MaimaiDX_UserRatings_UserRatingNextNewRatingListId",
                        column: x => x.UserRatingNextNewRatingListId,
                        principalTable: "MaimaiDX_UserRatings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserRates_MaimaiDX_UserRatings_UserRatingNextRatingListId",
                        column: x => x.UserRatingNextRatingListId,
                        principalTable: "MaimaiDX_UserRatings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserRates_MaimaiDX_UserRatings_UserRatingRatingListId",
                        column: x => x.UserRatingRatingListId,
                        principalTable: "MaimaiDX_UserRatings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<ulong>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserRatingId = table.Column<ulong>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaimaiDX_UserUdemaes_MaimaiDX_UserRatings_UserRatingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserActs_UserActivityMusicListId",
                table: "MaimaiDX_UserActs",
                column: "UserActivityMusicListId");

            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserActs_UserActivityPlayListId",
                table: "MaimaiDX_UserActs",
                column: "UserActivityPlayListId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserExtends_UserDetailId",
                table: "MaimaiDX_UserExtends",
                column: "UserDetailId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserOptions_UserDetailId",
                table: "MaimaiDX_UserOptions",
                column: "UserDetailId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserRates_UserRatingNewRatingListId",
                table: "MaimaiDX_UserRates",
                column: "UserRatingNewRatingListId");

            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserRates_UserRatingNextNewRatingListId",
                table: "MaimaiDX_UserRates",
                column: "UserRatingNextNewRatingListId");

            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserRates_UserRatingNextRatingListId",
                table: "MaimaiDX_UserRates",
                column: "UserRatingNextRatingListId");

            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserRates_UserRatingRatingListId",
                table: "MaimaiDX_UserRates",
                column: "UserRatingRatingListId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserRatings_UserDetailId",
                table: "MaimaiDX_UserRatings",
                column: "UserDetailId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaimaiDX_UserUdemaes_UserRatingId",
                table: "MaimaiDX_UserUdemaes",
                column: "UserRatingId",
                unique: true);
        }
